...
if_obj = open('./results/pima/if_t1-25_h6.txt')
if_y = list()
...
mb_obj = open('./results/pima/mb_t1-25_h6.txt')
mb_y = list()
...
hs_obj = open('./results/pima/hs_t1-25_h6.txt')
hs_obj.readline()
hs_y = list()
...
rs_obj = open('./results/pima/rs_t1-25_h6.txt')
rs_obj.readline()
rs_y = list()
...
plt.plot(x, rs_y, color='#a3159a', marker='4', label='RS-Forest')
# plt.xticks(x)
# plt.ylim((0.5, 1))
...
plt.show()
#
# plt.savefig('./results/http/f_t_h6_2.png', dpi=200)
