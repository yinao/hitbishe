...
from HashForest_Merge import HashForest

data = numpy.loadtxt('../data_series/ToeSegmentation2', delimiter=',')
labels = data[:, 0]
data = data[:, 1:]
# print data.shape
...
forest = HashForest()
forest.setup(sample_size=100, tree_size=40, node_size=15, k=35)
